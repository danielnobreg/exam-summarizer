            ...
            <div className="space-y-6 text-sm text-gray-600">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p>
                    Envie o arquivo PDF do seu exame laboratorial (clique ou
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p>
                    Nossa IA processará os dados e identificará os principais
                    resultados.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p>
                    O resultado formatado estará pronto para ser copiado e usado
                    onde precisar.
                  </p>
                </div>
              </div>
